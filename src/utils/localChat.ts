...
const CRISIS_KEYWORDS = [
  // ===== ENGLISH =====
  // Prefer full first-person phrases to avoid false positives on casual/third-party text
  ...
  'i have pills and i plan to use them',
  ...
  'i have sleeping pills and i will take them',
  'i have a knife and i will use it on myself',
  'i plan to jump off the bridge',
  'i will hang myself',

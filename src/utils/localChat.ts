...
// Only full self-harm sentences and explicit crisis phrases are used here to reduce false positives from single-word matches.
const CRISIS_KEYWORDS = [
  ...
  'i want to die',
  'i want to do self harm',
  'i am cutting myself',
  'i want to take an overdose',
  ...
  'i am going to step in front of a car',
  'i am planning to slash my wrists',
  'i am planning to poison myself',
  'i am planning to drown myself',
  'i am going to use sleeping pills to die',
  'i am going to cut myself and bleed out',
